...
function M.term_open()
  ...
  local open_term_cmd = ':rightb'.. M.config_values.display_options.terminal_width .. 'vsplit'
...
function M.display_nvim_notify(message, ok)
    ...
    require("notify")(message, notif_style, {title=title, timeout=M.config_values.display_options.notification_timeout})
end
