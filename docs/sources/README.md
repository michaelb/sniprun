...
- Sniprun is compatible with **Linux** and **MacOS**. (Mac users _need_ the Rust [toolchain](https://www.rust-lang.org/tools/install) version >= 1.59 ). Standard POSIX utilities (grep, cut, sed ...) are needed too.
